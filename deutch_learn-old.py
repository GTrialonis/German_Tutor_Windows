...
class VocabularyApp:
    ...
    def create_left_section(self):
        ...
        self.vocabulary_textbox = self.create_labeled_textbox(left_frame, "Vocabulary (Current):", True, height=9, label_font=font, add_buttons=False)
        ...
        self.study_textbox.bind('<Double-Button-1>', self.on_study_text_double_click) # debug
        self.translation_textbox = self.create_labeled_textbox(left_frame, "Translation Box:", True, height=9, label_font=font, add_buttons=True)
    ...
    # -------------------- NOUN LOOK-UP -----------------
    # Handler function for looking up nouns by double-clicking on them inside the Study Textbox
    def on_study_text_double_click(self, event):
        ...
        try:
            ...
            # Check if it's a German noun (starts with capital letter)
    ...
    def lookup_german_noun(self, noun):
        ...
        Include loanwords and foreign words that are used as nouns in German.
        """
        
        try:
            # Use direct OpenAI call instead of get_ai_response
            response = self.client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
    ...
    # ----------------- END OF NOUN LOOK-UP functionality

    def get_noun_declension(self, noun):
        """Get noun declension - replace with real dictionary lookup"""
        # This is a mockup - you'd replace this with a real German dictionary
        noun_data = {
            "Diskurs": ("der", "Diskurse"),
            "Haus": ("das", "Häuser"),
            "Frau": ("die", "Frauen"),
            "Mann": ("der", "Männer"),
            "Buch": ("das", "Bücher"),
